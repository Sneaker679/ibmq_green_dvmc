...
if generate_matrix.upper() == 'ALL':
    for type in ['H+','H-','S+','S-']:
        print(type+':')
        print(em.matrix(type,excit_document,N,N_min,spin_left,spin_right,Hamiltonian,circuit,generate_npy))
        print()
else:
    print(generate_matrix+':')
    print(em.matrix(generate_matrix,excit_document,N,N_min,spin_left,spin_right,Hamiltonian,circuit,generate_npy))
