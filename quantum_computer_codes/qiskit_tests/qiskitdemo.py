...
qubit_converter = QubitConverter(JordanWignerMapper()) #convertisseur e^- -> qubits
HHam = qubit_converter.convert(Ham) #La hamiltonien d'électron est convertie en hamiltonien de qubit
